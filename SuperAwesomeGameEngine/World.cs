...
namespace SuperAwesomeGameEngine
{
    ...
    //A static class is a place to hold shared resources (variables and methods).
    //One thing you can do with a static class (and a static variable) is to hold values such as a system-wide counter.
    {
        ...
        //You might be thinking, "Wait! We can't instantiate a static class, so why does it have a constructor? After all, that's what a constructor is used for, instantiating an object!"
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new HealthPotion(ITEM_ID_HEALING_POTION, "Health Potion", "Health Potions", 5));
